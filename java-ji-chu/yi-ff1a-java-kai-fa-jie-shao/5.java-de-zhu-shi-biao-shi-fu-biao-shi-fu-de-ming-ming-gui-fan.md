...
## 总结
1. 开发中的命名规范是必须的，不管是在公司里，还是在开源项目中
2. [阿里巴巴Java开发手册](https://github.com/alibaba/p3c/tree/master/p3c-gitbook)有很高的借鉴意义，建议根据实际情况做自己的开发规范，同时还提供插件的使用文档
3. [ Google 开源项目风格指南](https://zh-google-styleguide.readthedocs.io/en/latest/contents/)包括了：Google 开源项目风格指南 (中文版)、C++ 风格指南 、Objective-C 风格指南、Python 风格指南、Shell 风格指南。
...
- [阿里巴巴Java开发手册 github](https://github.com/alibaba/p3c/tree/master/p3c-gitbook)
...
## 阿里巴巴Java开发手册介绍
每个公司都会有自己的开发规范，作为中国技术比较强的企业，JAVA编码规范是很有借鉴意义的。一个公司的JAVA编程规范，主要的目的我觉得可能有以下几个原因：

1. 代码的美观程度,不管是你提供的API还是别人借鉴你的代码，都可以很舒服的阅读你的代码，一个程序猿如果写的代码便于别人理解，别人更容易的接受你，觉得你是个大神。
2. 便于维护，一个项目工期很长，往往不仅仅是你一个人维护自己的代码，还需要维护别人的代码或者使用调用别人的代码，良好编程规范更容易团队协作。

## 代码编程规范注意点

1. 代码注释：一个工程项目往往是需要数月甚至数年才能有一个开放阶段，良好的代码注释，在你查看你的历史代码的时候，可以迅速的回忆起来，别人在读你代码的时候也更赏心悦目，更容易理解。
2. 命名规范：主要为了区分代码中的不同类型，常量，变量，方法，静态方法，类等等，并且使用驼峰法来命名。
